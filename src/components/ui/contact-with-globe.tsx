...
const CONTACT_LINKS = [
  { icon: Mail, label: 'contacto@cybersys.pro', href: 'mailto:contacto@cybersys.pro' },
  { icon: Phone, label: '+51 999 999 999', href: 'tel:+51999999999' },
  { icon: Headphones, label: 'soporte@cybersys.pro', href: 'mailto:soporte@cybersys.pro' },
];
